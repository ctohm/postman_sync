const Promise = require('bluebird'),
  ...
  chalk = require('chalk'),
  responsesUtils = require(`${process.env.UTILS_FOLDER}/responses-utils.js`),
  replaceSummary = require(`${process.env.UTILS_FOLDER}/replace_summary.js`);
...
function enrichContent(content, verbose) {
  debug({verbose});
