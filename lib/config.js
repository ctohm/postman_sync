...
function createConfig(options) {
  ...
  try {
    console.log(
      `will try to create folder under "{OUTPUT_FOLDER}/json_collections" if they don't exist`
    );
    mkdirp.sync(`${OUTPUT_FOLDER}/json_collections`);
    mkdirp.sync(`${OUTPUT_FOLDER}/json_collections/in_process`);

    console.log(
      `will try to create folders  under "{OUTPUT_FOLDER}/json_environments" if they don't exist`
    );
    mkdirp.sync(`${OUTPUT_FOLDER}/json_environments`);

    console.log(
      `will try to create folders under "{OUTPUT_FOLDER}/specs" if they don't exist`
    );
